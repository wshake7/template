...
func ({{.ModelName | toLower}}) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.{{.ModelName}}))
...
func (s {{.ModelName | toLower}}) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.{{.ModelName}}], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.{{.ModelName}}))
	...
	return &gormc.PagingResult[models.{{.ModelName}}]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s {{.ModelName | toLower}}) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.{{.ModelName}}], error) {
	if req == nil {
