...
type SysResource struct {
	...
	mixin.Remark
	mixin.Metadata
	DeletedAt soft_delete.DeletedAt `gorm:"column:deleted_at;softDelete:milli;not null;default:0;uniqueIndex:idx_sys_resource_code_deleted_at,priority:2" json:"deletedAt"`
