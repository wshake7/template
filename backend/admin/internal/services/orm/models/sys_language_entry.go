...
type SysLanguageEntry struct {
	...
	mixin.IsEnabled
	mixin.Remark
	DeletedAt         soft_delete.DeletedAt `gorm:"column:deleted_at;softDelete:milli;default:0;uniqueIndex:idx_sys_language_entry_code_language_type_id_deleted_at,priority:3" json:"deletedAt"`
