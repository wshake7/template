...
type SysDataPermission struct {
	...
	Action        datatypes.JSON        `gorm:"column:action;not null;default:'[\"read\"]';uniqueIndex:idx_sys_data_permission_subject_resource_action_deleted_at,priority:5;comment:操作列表(read/write/delete)" json:"action"`
