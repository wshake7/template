...
type SysLanguageType struct {
	...
	mixin.SortOrder
	mixin.IsEnabled
	DeletedAt soft_delete.DeletedAt `gorm:"column:deleted_at;softDelete:milli;default:0;uniqueIndex:idx_sys_language_type_code_deleted_at,priority:2" json:"deletedAt"`
