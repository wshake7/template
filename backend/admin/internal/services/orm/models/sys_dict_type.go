...
type SysDictType struct {
	...
	mixin.SortOrder
	mixin.Remark
	DeletedAt soft_delete.DeletedAt `gorm:"column:deleted_at;softDelete:milli;not null;default:0;uniqueIndex:idx_sys_dict_type_type_code_deleted_at,priority:2" json:"deletedAt"`
