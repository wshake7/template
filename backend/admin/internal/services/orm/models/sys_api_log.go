...
type SysApiLog struct {
	...
	SysUserID      *uint64 `gorm:"column:sys_user_id;type:bigint;default:null;index:idx_sys_api_log_sys_user_id;comment:操作者用户ID" json:"sysUserID"`
	ClientIP       string  `gorm:"column:client_ip;type:varchar(64);default:'';comment:操作者IP" json:"clientIP"`
	StatusCode     int     `gorm:"column:status_code;type:int;default:0;index:idx_sys_api_log_status_code;comment:状态码" json:"statusCode"`
