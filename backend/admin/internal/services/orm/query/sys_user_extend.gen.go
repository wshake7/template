...
func (sysUser) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysUser))
...
func (s sysUser) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysUser], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysUser))
	...
	return &gormc.PagingResult[models.SysUser]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysUser) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysUser], error) {
	if req == nil {
