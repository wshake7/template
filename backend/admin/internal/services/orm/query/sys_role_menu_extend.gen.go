...
func (sysRoleMenu) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysRoleMenu))
...
func (s sysRoleMenu) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysRoleMenu], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysRoleMenu))
	...
	var entities []*models.SysRoleMenu
	...
	return &gormc.PagingResult[models.SysRoleMenu]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysRoleMenu) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysRoleMenu], error) {
	if req == nil {
