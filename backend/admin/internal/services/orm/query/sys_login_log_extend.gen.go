...
func (sysLoginLog) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysLoginLog))
...
func (s sysLoginLog) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysLoginLog], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysLoginLog))
	...
	var entities []*models.SysLoginLog
	...
	return &gormc.PagingResult[models.SysLoginLog]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysLoginLog) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysLoginLog], error) {
	if req == nil {
