...
func (sysUserRole) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysUserRole))
...
func (s sysUserRole) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysUserRole], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysUserRole))
	...
	var entities []*models.SysUserRole
	...
	return &gormc.PagingResult[models.SysUserRole]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysUserRole) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysUserRole], error) {
	if req == nil {
