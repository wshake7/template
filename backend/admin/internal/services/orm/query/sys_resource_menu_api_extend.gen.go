...
func (sysResourceMenuApi) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysResourceMenuApi))
...
func (s sysResourceMenuApi) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysResourceMenuApi], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysResourceMenuApi))
	...
	var entities []*models.SysResourceMenuApi
	...
	return &gormc.PagingResult[models.SysResourceMenuApi]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysResourceMenuApi) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysResourceMenuApi], error) {
	if req == nil {
