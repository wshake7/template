...
func (jobExecution) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.JobExecution))
...
func (s jobExecution) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.JobExecution], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.JobExecution))
	...
	var entities []*models.JobExecution
	...
	return &gormc.PagingResult[models.JobExecution]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s jobExecution) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.JobExecution], error) {
	if req == nil {
