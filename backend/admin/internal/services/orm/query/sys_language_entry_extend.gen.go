...
func (sysLanguageEntry) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysLanguageEntry))
...
func (s sysLanguageEntry) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysLanguageEntry], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysLanguageEntry))
	...
	var entities []*models.SysLanguageEntry
	...
	return &gormc.PagingResult[models.SysLanguageEntry]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysLanguageEntry) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysLanguageEntry], error) {
	if req == nil {
