...
type ISysUserDo interface {
	...
	Unscoped() ISysUserDo
	Create(values ...*models.SysUser) error
	CreateInBatches(values []*models.SysUser, batchSize int) error
	Save(values ...*models.SysUser) error
	First() (*models.SysUser, error)
	Take() (*models.SysUser, error)
	Last() (*models.SysUser, error)
	Find() ([]*models.SysUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.SysUser, err error)
	FindInBatches(result *[]*models.SysUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.SysUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.SysUser, error)
	FirstOrCreate() (*models.SysUser, error)
	FindByPage(offset int, limit int) (result []*models.SysUser, count int64, err error)
