...
func (sysDataPermission) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysDataPermission))
...
func (s sysDataPermission) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysDataPermission], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysDataPermission))
	...
	var entities []*models.SysDataPermission
	...
	return &gormc.PagingResult[models.SysDataPermission]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysDataPermission) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysDataPermission], error) {
	if req == nil {
