...
func (sysResource) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysResource))
...
func (s sysResource) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysResource], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysResource))
	...
	var entities []*models.SysResource
	...
	return &gormc.PagingResult[models.SysResource]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysResource) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysResource], error) {
	if req == nil {
