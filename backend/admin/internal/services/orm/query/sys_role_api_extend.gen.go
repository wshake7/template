...
func (sysRoleApi) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysRoleApi))
...
func (s sysRoleApi) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysRoleApi], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysRoleApi))
	...
	var entities []*models.SysRoleApi
	...
	return &gormc.PagingResult[models.SysRoleApi]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysRoleApi) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysRoleApi], error) {
	if req == nil {
