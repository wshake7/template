...
func (sysDictEntry) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysDictEntry))
...
func (s sysDictEntry) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysDictEntry], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysDictEntry))
	...
	var entities []*models.SysDictEntry
...
func (s sysDictEntry) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysDictEntry], error) {
	if req == nil {
