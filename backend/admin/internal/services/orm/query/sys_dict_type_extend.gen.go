...
func (sysDictType) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysDictType))
...
func (s sysDictType) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysDictType], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysDictType))
	...
	var entities []*models.SysDictType
	...
	return &gormc.PagingResult[models.SysDictType]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysDictType) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysDictType], error) {
	if req == nil {
