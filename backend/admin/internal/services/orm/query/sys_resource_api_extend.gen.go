...
func (sysResourceApi) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysResourceApi))
...
func (s sysResourceApi) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysResourceApi], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysResourceApi))
	...
	var entities []*models.SysResourceApi
	...
	return &gormc.PagingResult[models.SysResourceApi]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysResourceApi) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysResourceApi], error) {
	if req == nil {
