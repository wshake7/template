...
func (sysResourceMenu) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysResourceMenu))
...
func (s sysResourceMenu) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysResourceMenu], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysResourceMenu))
	...
	var entities []*models.SysResourceMenu
	...
	return &gormc.PagingResult[models.SysResourceMenu]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysResourceMenu) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysResourceMenu], error) {
	if req == nil {
