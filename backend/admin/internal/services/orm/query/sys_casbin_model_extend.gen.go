...
func (sysCasbinModel) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysCasbinModel))
...
func (s sysCasbinModel) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysCasbinModel], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysCasbinModel))
	...
	var entities []*models.SysCasbinModel
	...
	return &gormc.PagingResult[models.SysCasbinModel]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysCasbinModel) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysCasbinModel], error) {
	if req == nil {
