...
func (jobSchedule) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.JobSchedule))
...
func (s jobSchedule) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.JobSchedule], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.JobSchedule))
	...
	var entities []*models.JobSchedule
	...
	return &gormc.PagingResult[models.JobSchedule]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s jobSchedule) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.JobSchedule], error) {
	if req == nil {
