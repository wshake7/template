...
func (sysLanguageType) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysLanguageType))
...
func (s sysLanguageType) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysLanguageType], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysLanguageType))
	...
	var entities []*models.SysLanguageType
	...
	return &gormc.PagingResult[models.SysLanguageType]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysLanguageType) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysLanguageType], error) {
	if req == nil {
