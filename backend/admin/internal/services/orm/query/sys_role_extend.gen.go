...
func (sysRole) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.SysRole))
...
func (s sysRole) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.SysRole], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.SysRole))
	...
	return &gormc.PagingResult[models.SysRole]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s sysRole) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.SysRole], error) {
	if req == nil {
